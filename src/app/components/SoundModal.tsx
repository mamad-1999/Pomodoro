      ...
      <div className="relative w-auto my-6 mx-auto max-w-3xl z-20">
        ...
        <div className="md:w-96 w-80 border-0 rounded shadow-lg relative flex flex-col bg-white outline-none focus:outline-none select-none">
          ...
          <div className="w-full flex justify-center items-center gap-14 py-2">
            <button
              type="button"
              onClick={() => alarmControl()}
              className="flex flex-col justify-center items-center gap-2 cursor-pointer"
            >
              <div
                className={`w-12 h-12 ${
                  isAlarmOn ? "bg-orange-600" : "bg-gray-400"
                } rounded-full flex items-center justify-center`}
              >
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  className={`w-8 h-8 ${
                    isAlarmOn ? "fill-white" : "fill-zinc-600"
                  }`}
                  viewBox="0 0 24 24"
                >
            ...
            <button
              type="button"
              onClick={() => tikTokControl()}
              className="flex flex-col justify-center items-center gap-2 cursor-pointer"
            >
              <div
                className={`w-12 h-12 ${
                  isTikTokOn ? "bg-orange-600" : "bg-gray-400"
                } rounded-full flex items-center justify-center`}
              >
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  className={`w-8 h-8 ${
                    isTikTokOn ? "fill-white" : "fill-zinc-600"
                  }`}
                  viewBox="0 0 24 24"
                >
